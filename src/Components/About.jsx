...
const About = () => {
    return (
        ...
        <section className="bg-black px-12 mx-12">
            <div className="px-8 py-8 mx-8">
                ...
                <p className="mt-4 block max-w-4xl text-gray-500">
                    Eeztek is a service-based IT company that helps businesses of all sizes to achieve their goals with technology. We offer a comprehensive range of IT services, including managed IT services, cloud computing, cybersecurity, application development, and IT consulting.

                    Our team of experienced and certified IT professionals is passionate about helping our clients to succeed. We understand that technology can be complex and overwhelming, so we take the time to understand your specific needs and develop tailored solutions that meet your budget and goals.
                    We believe that technology should be a tool that helps businesses to grow and succeed, not a burden. That's why we offer a wide range of services and support to help our clients get the most out of their IT infrastructure.
                </p>
                <br></br><br></br><br></br>
                {/* <div className="mt-6">
                    <a
