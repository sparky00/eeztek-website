            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <path
                  ...
                  fill="#39393A"
                ></path>
                <path d="M280.5 530h325.9v16H280.5z" fill="#39393A"></path>
                <path d="M639.5 530h90.2v16h-90.2z" fill="#E73B37"></path>
                <path d="M403.5 641.8h277v16h-277z" fill="#39393A"></path>
                <path d="M280.6 641.8h91.2v16h-91.2z" fill="#E73B37"></path>
                <path d="M279.9 753.7h326.5v16H279.9z" fill="#39393A"></path>
                <path d="M655.8 753.7h73.9v16h-73.9z" fill="#E73B37"></path>
              </g>
            </svg>
          </div>
          <h3 className="mt-8 text-lg font-semibold text-black">
        ...
        <div>
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                <path
                  d="M512 599.6L107.9 311.1v19.7L512 619.3l404.1-288.6V311L512 599.6z"
                  fill="#E73B37"
                ></path>
                <path
                ...
                ></path>
                <path
                  d="M512.9 536.7m-10 0a10 10 0 1 0 20 0 10 10 0 1 0-20 0Z"
                  fill="#E73B37"
                ></path>
              </g>
            </svg>
        ...
        <div>
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
            ...
            >
              ...
              ></g>
              <g id="SVGRepo_iconCarrier">
                <path d="M928.1 881v44H95.9V99h44v782z" fill="#39393A"></path>
                <path
