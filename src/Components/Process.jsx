    ...
    <div className="mx-auto max-w-7xl px-2 lg:px-8 bg-cyan-400">
      ...
      <div className="grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
        ...
        <div>
          ...
          <h3 className="mt-8 text-lg font-semibold text-white">Prototype</h3>
          <p className="mt-4 text-sm text-gray-600">
        ...
        <div>
          ...
          <h3 className="mt-8 text-lg font-semibold text-white">Development</h3>
          <p className="mt-4 text-sm text-gray-600">
      ...
      <div className="grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-3">
        ...
        <div>
          ...
          <h3 className="mt-8 text-lg font-semibold text-white">Deployment</h3>
          <p className="mt-4 text-sm text-gray-600">
            After trial and following all processes, your app is ready to launch
