      ...
      <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12 xl:grid-cols-3 xl:gap-16">
        ...
        <div className="border-solid border rounded-md border-grey p-5 space-y-3">
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                d="M840.5 798.2L662.3 599.5l-151 173.7-173.7-173.7-167.7 201c-21 30.4 0.9 71.8 37.9 71.6l594.7-3.3c36.2-0.1 57.8-40.3 38-70.6z"
                fill="#FFB89A"
              ></path>
              <path
              ...
              ></path>
              <path
                d="M721.3 342.8m-35.1 0a35.1 35.1 0 1 0 70.2 0 35.1 35.1 0 1 0-70.2 0Z"
                fill="#06f3ff"
              ></path>
              <path
